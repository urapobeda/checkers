      ...
      <main className="mx-auto grid w-full max-w-7xl gap-4 px-4 pb-28 md:grid-cols-2 md:px-8 lg:pb-16">
        {tips.map((tip) => (
          <Surface key={tip.title} className="overflow-hidden p-0">
            <div className="grid aspect-video place-items-center bg-[linear-gradient(135deg,rgba(35,221,255,0.16),rgba(255,184,77,0.12))]">
              <span className="grid h-16 w-16 place-items-center rounded-full bg-slate-950/70 text-[var(--cyan)]">
