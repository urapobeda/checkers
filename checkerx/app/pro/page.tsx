  ...
  return (
    <AppShell>
      <PageHeader
        ...
        body="CheckerX Elite will unlock deeper reviews, custom skins, mistake drills, and visible Elite user status."
      />
      <main className="mx-auto grid w-full max-w-7xl gap-5 px-4 pb-28 md:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:pb-16">
        <Surface>
          ...
          <p className="mt-4 text-5xl font-black text-white">$9<span className="text-base font-bold text-stone-400">/mo demo</span></p>
          <p className="mt-4 text-sm leading-6 text-stone-300">
            No card collection for the prototype. This button will save local Elite status first, then Supabase subscription state later.
          </p>
          <div className="mt-6">
        ...
        <Surface className="lg:col-span-2">
          <div className="grid gap-3 md:grid-cols-4">
            {["No real payment", "Elite badge", "Skin marketplace idea", "Deeper AI coach"].map((item) => (
