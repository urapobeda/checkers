    ...
    <AppShell>
      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-28 md:px-8 lg:pb-16">
        <Surface className="overflow-hidden p-0">
          <div className="grid grid-cols-[4rem_1fr_0.8fr_0.8fr_1fr] gap-3 border-b border-white/10 px-4 py-3 text-xs font-black uppercase tracking-[0.16em] text-stone-500">
            <span>Rank</span>
            <span>Player</span>
            <span>City</span>
            <span>Rating</span>
          ...
          {leaderboard.map((player, index) => (
            <div key={player.name} className="grid grid-cols-[4rem_1fr_0.8fr_0.8fr_1fr] items-center gap-3 border-b border-white/8 px-4 py-4 last:border-b-0">
              ...
              <span>
                ...
                <span className="mt-1 block text-xs text-stone-500">Coach score {player.coach}</span>
              </span>
